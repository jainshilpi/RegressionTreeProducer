...
process.source = cms.Source(
    ...
    fileNames = cms.untracked.vstring('file:/eos/cms/store/group/phys_egamma/PFClusterCalibration/debug_2018UL/skimEGMobjects_fromRAW_orig.root')
    )
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("/eos/cms/store/group/phys_egamma/PFClusterCalibration/debug_2018UL/tree.root"),
